      ...
      <div className="container mx-auto max-w-4xl px-4 py-8">
        <div className="space-y-6">
                ...
                {section.settings.map((setting, settingIndex) => (
                  ...
                  >
                    ...
                    {setting.type === "select" && setting.options && (
                      <select
                        value={
                          setting.label === "SCHEME"
                            ? settings.controlScheme
                            : settings.quality
                        }
                        onChange={(e) => {
                          if (setting.label === "SCHEME") {
                            setSettings((prev) => ({
                              ...prev,
                              scheme: e.target.value,
                            }));
                          } else if (setting.label === "QUALITY") {
                            setSettings((prev) => ({
                              ...prev,
                        ...
                        className="border border-border bg-input px-3 py-2 text-foreground"
                      >
          ...
          <div className="flex gap-4">
            <button
              className="flex-1 border border-border bg-card px-4 py-3 transition-colors hover:bg-muted"
              style={{ fontFamily: "monospace" }}
            >
              RESET
            </button>
            <button
              className="flex-1 border border-primary bg-primary px-4 py-3 text-primary-foreground transition-all hover:bg-transparent hover:text-primary"
              style={{ fontFamily: "monospace" }}
            >
              SAVE
            </button>
